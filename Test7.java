...
public class TestGenerator {
    ...
    private static void generateMockSetup(CodeBlock.Builder code, MethodCallInfo call) {
        if (!call.scope.isEmpty() && !call.scope.equals("this")) {
            code.addStatement("$T.when($L.$L($L)).thenReturn($T.mock($T.class))",
    ...
    static class DependencyCollector extends VoidVisitorAdapter<Void> {
        ...
        public void visit(FieldDeclaration n, Void arg) {
            dependencies.add(n.getElementType().asString());
            super.visit(n, arg);
        }
        ...
        public void visit(MethodCallExpr n, Void arg) {
            ...
            methodCalls.add(new MethodCallInfo(scope, methodName, returnType, calledWithin));
            super.visit(n, arg);
        }

        @Override
        public void visit(CatchClause n, Void arg) {
            n.findAncestor(MethodDeclaration.class)
                    .map(MethodDeclaration::getNameAsString)
                    .ifPresent(exceptionMethods::add);
            super.visit(n, arg);
        }
    }
    ...
    static class MethodCallInfo {
        ...
        MethodCallInfo(String scope, String methodName, String returnType, String calledWithin) {
            this.scope = scope;
